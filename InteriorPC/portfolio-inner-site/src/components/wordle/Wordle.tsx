    ...
    return (
        <div style={styles.container}>
            <div style={styles.header}>
                ...
                <p>Wordle pero con un giro basado en YALIL.</p>
                {showHelp && (
                    <div style={styles.helpTooltip}>
                        <p style={styles.helpTitle}><b>¿Cómo jugar?</b></p>
                        <p style={styles.helpLine}>Adivina la palabra en 6 intentos.</p>
                        <p style={styles.helpLine}>Después de cada intento:</p>
                        <p style={styles.helpLine}>🟩 Verde = letra correcta en posición correcta</p>
                        <p style={styles.helpLine}>🟨 Amarillo = letra correcta en posición incorrecta</p>
                        <p style={styles.helpLine}>⬜ Gris = letra no está en la palabra</p>
                    </div>
                )}
            </div>
            <motion.div
            ...
            >
                <h2>{won ? '¡Ganaste!' : 'Juego Terminado'}</h2>
                <p>¡Gracias por jugar! Recuerda: la palabra siempre es "YALIL"</p>
                <br />
                <GuessWord
                    key={'winning-guess'}
                    guess={word}
