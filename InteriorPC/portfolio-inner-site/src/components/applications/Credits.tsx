...
const CREDITS = [
    {
        ...
        rows: [['Yalil Musa Talhaoui', 'Desarrollo Full-Stack']],
    },
    {
    ...
    },
    {
        ...
        rows: [
            ...
            ['Henry Heffernan', 'Texturas Originales'],
        ],
    },
    {
        title: 'Agradecimientos Especiales',
        rows: [
            ['Henry Heffernan', 'Portfolio 3D Original'],
            ['Bruno Simon', 'Inspiración Three.js'],
            ['Familia & Amigos', 'Apoyo Constante'],
        ],
    },
    {
        title: 'Inspiración',
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        >
            ...
            >
                <h2>Créditos</h2>
                <p>yalilmusa.netlify.app, 2025</p>
                <br />
                <br />
                <br />
